...
//! `cargo nextest run -p ferroehr-admin-ui --features ssr` lane.
//!
...
use ferroehr_admin_ui::activity::ActivityPoint;
use ferroehr_admin_ui::components::activity_chart::activity_chart;
use ferroehr_admin_ui::components::brand::Wordmark;
use ferroehr_admin_ui::components::confirm_dialog::ConfirmDialog;
use ferroehr_admin_ui::components::empty_state::EmptyState;
use ferroehr_admin_ui::components::page_header::{Crumb, PageHeader};
use ferroehr_admin_ui::components::scope_grants::{
...
fn the_not_found_screen_offers_a_way_back_to_the_dashboard() {
    let html = render(|| {
        ...
        thaw_shell(|| {
            view! {
                <leptos_router::components::Router>
                    <ferroehr_admin_ui::app::NotFound />
                </leptos_router::components::Router>
            }
            .into_any()
        })
