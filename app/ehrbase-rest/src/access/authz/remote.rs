...
use crate::access::authz::config::{AbacConfig, AbacParam, PolicyRule};
use crate::access::authz::engine::{AuthzError, PolicyEngine};
use crate::access::authz::request::{AuthzRequest, Combination, Decision};
...
pub struct RemotePdp {
    ...
    ///
    /// [`ResourceKind::config_key`]: crate::access::authz::request::ResourceKind::config_key
