...
//! the assembled router over a **real** `EhrbaseService` on a real
...
#[allow(clippy::needless_pass_by_value)] // fixture builder: owned Vec keeps nested literals readable
...
async fn update_and_delete_without_directory_error() {
    ...
    let dummy = format!("{}::ehrbase-rs::1", Uuid::new_v4());
