...
//! well-formed TDD for a provisioned template is converted (`openehr_sdt::flat::tdd::from_tdd`)
...
/// body walk, `openehr_sdt::flat::tdd::from_tdd`) and committed through the validated
