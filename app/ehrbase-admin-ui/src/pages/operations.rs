...
//!   document (`/ehrbase/rest/status`: is the API answering, at which version).
...
//!   `EhrbaseConfig::to_redacted_json` value, the management route adding a
            ...
            <div class="mt-3 flex flex-wrap items-end gap-2">
                <label class="flex flex-col gap-1 text-xs text-ink-muted">
                    ...
                    <input
                        ...
                        placeholder="ehrbase=debug,sqlx=warn"
