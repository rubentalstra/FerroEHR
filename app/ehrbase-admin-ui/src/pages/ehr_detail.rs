...
mod tests {
    use super::{
        DIRECTORY_ARCHETYPE, LIST_COMPOSITIONS_AQL, commit_version_uid, directory_toast_detail,
        empty_root_folder, folder_json, format_from_value, format_value, parse_contributions,
        versioned_object_id,
    };
    use crate::format::ReprFormat;
    ...
    fn folder_json_builds_a_spec_valid_folder_node() {
        let leaf = folder_json(super::FOLDER_NODE_ID, "2026", &[]);
