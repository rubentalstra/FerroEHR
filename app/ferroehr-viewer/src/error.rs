...
impl ViewerError {
    ...
    ///
    /// [`ViewerError::Cdr`] transports the status as a `u16` because the enum
    ...
    /// else"; [`ViewerError::Unauthenticated`] answers `None` because no CDR
...
impl leptos::server_fn::error::FromServerFnError for ViewerError {
