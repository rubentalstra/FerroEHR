...
mod tests {
    ...
    fn golden_ehr_create() {
        ...
        assert!(xml.contains(r#"UserID="ehrbase""#));
    ...
    fn composition_read() {
        ...
        assert!(xml.contains(r#"ParticipantObjectID="8fa1::ehrbase::1""#));
    ...
    fn composition_update() {
        ...
        e.object_id = Some("8fa1::ehrbase::2".to_owned());
    ...
    fn composition_delete() {
        ...
        e.object_id = Some("8fa1::ehrbase::3".to_owned());
        let xml = AuditMessage::build(&e, &ctx(), Some("patient-42"))
            .to_xml()
            .expect("xml");
