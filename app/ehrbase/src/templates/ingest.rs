...
//! [`crate::validation::validate_opt_structure`] (the artefact-validity area
//! owns all validity checks) closes the leniency the codec would otherwise
//! accept — the store calls it before every ingest.
//!
