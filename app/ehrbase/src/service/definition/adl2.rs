...
impl EhrbaseService {
    ...
    async fn adl2_exists(&self, an_id: &str) -> Result<bool, ServiceError> {
    ...
    /// identifier body).
    async fn adl2_upload(&self, adl2: &str) -> Result<String, ServiceError> {
