...
| `http2_keep_alive_interval_secs` | int | `30` | Interval between HTTP/2 keep-alive PINGs, in seconds. `0` disables them — a peer that vanishes without a FIN is then held until the operating system notices. |
