...
```shell
helm show chart oci://ghcr.io/rubentalstra/charts/ferroehr --version 6.0.18
```
...
|---|---|---|---|
| Chart version | templates, values schema, defaults | `--version 6.0.18` | SemVer over the chart's own contract |
...
>
> ```shell
> helm template ferroehr oci://ghcr.io/rubentalstra/charts/ferroehr --version 6.0.18 \
...
helm upgrade ferroehr oci://ghcr.io/rubentalstra/charts/ferroehr \
  --version 6.0.18 -n ferroehr --reuse-values \
