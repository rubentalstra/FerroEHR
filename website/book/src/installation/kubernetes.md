...
```shell
helm show chart oci://ghcr.io/rubentalstra/charts/ferroehr --version 8.2.1
```
...
|---|---|---|---|
| Chart version | templates, values schema, defaults | `--version 8.2.1` | SemVer over the chart's own contract |
...
>
> ```shell
> helm template ferroehr oci://ghcr.io/rubentalstra/charts/ferroehr --version 8.2.1 \
...
helm upgrade ferroehr oci://ghcr.io/rubentalstra/charts/ferroehr \
  --version 8.2.1 -n ferroehr --reuse-values \
...
```shell
FERROEHR_IMAGE=ghcr.io/rubentalstra/ferroehr:4.1.1 \
