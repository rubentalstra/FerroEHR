...
| Image tag | the server binary | `--set image.tag=4.0.6-rc3` (or `image.digest`) | the application's SemVer line |
...
```shell
FERROEHR_IMAGE=ghcr.io/rubentalstra/ferroehr:4.0.6-rc3 \
