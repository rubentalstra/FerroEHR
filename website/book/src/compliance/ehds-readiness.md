...
| European logging software component for EHR systems | Partial ([#3170](https://github.com/rubentalstra/FerroEHR/issues/3170)) | Annex II 3.2 lists five things every access event must record. The access-event model records the agent, the subject, the object and its domain, the outcome, the purpose and the time, and the audit trail is retrievable. Whether each of the five maps onto a field without a gap is the mapping #3170 exists to establish. |
...
| 3.2 | The European logging software component records, for every access event or group of events, at least the accessing provider or individual, the natural person accessed, the categories of data, the time and date, and the origin of the data. | Partial | [The access trail, per record rather than per operation](../audit.md) | **Gap:** The trail records the agent, the subject, the object and its pseudonymisation domain, the purpose, the outcome and the time. Point (e), the origin of the data, has no dedicated field, and whether point (c) is satisfied by the object's domain and type is the mapping question #3170 answers. Tracked in [#3170](https://github.com/rubentalstra/FerroEHR/issues/3170) |
