...
| [EHDS](https://eur-lex.europa.eu/eli/reg/2025/327/oj) | EU | Annex II 3.2 | The split clinical role holds no grant on the audit schema, so a separated deployment cannot write its own access log | [#3267](https://github.com/rubentalstra/FerroEHR/issues/3267) | Planned | — |
