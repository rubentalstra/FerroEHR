...
| [GDPR](https://eur-lex.europa.eu/eli/reg/2016/679/oj) | EU | Art. 18 | A restriction register at whole-EHR and single-object grain, with the marked object refused on every read, query, export, event and write path while its stored rows stay untouched | [#3324](https://github.com/rubentalstra/FerroEHR/issues/3324) | Planned | — |
| [GDPR](https://eur-lex.europa.eu/eli/reg/2016/679/oj) | EU | Art. 21(6) | A per-EHR research objection that removes the record from population queries, exports and the event stream while leaving reads for care untouched, with the controller's public-interest override recorded beside it | [#3325](https://github.com/rubentalstra/FerroEHR/issues/3325) | Planned | — |
...
| [BDSG](https://www.gesetze-im-internet.de/bdsg_2018/) | DE | § 35 Abs. 2 and 3 | A restriction register at whole-EHR and single-object grain, with the marked object refused on every read, query, export, event and write path while its stored rows stay untouched | [#3324](https://github.com/rubentalstra/FerroEHR/issues/3324) | Planned | — |
