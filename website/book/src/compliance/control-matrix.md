...
| [GDPR](https://eur-lex.europa.eu/eli/reg/2016/679/oj) | EU | Art. 89(1) | feat(ext): secondary use leaves through FerroBRIDGE to OMOP: the CDR keeps the outbox, the restriction, objection and retention marks and a resumable batch export; no in-CDR research domain | [#3379](https://github.com/rubentalstra/FerroEHR/issues/3379) | Planned | — |
...
| [EHDS](https://eur-lex.europa.eu/eli/reg/2025/327/oj) | EU | Chapter IV | feat(ext): secondary use leaves through FerroBRIDGE to OMOP: the CDR keeps the outbox, the restriction, objection and retention marks and a resumable batch export; no in-CDR research domain | [#3379](https://github.com/rubentalstra/FerroEHR/issues/3379) | Planned | — |
