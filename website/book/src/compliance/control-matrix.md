...
| [GDPR](https://eur-lex.europa.eu/eli/reg/2016/679/oj) | EU | Art. 18 | law(EU): a restriction of processing finer than the EHR (Art. 18 GDPR, Art. 4(3)), marking a composition so every read, query and export path skips it while storage continues | [#3324](https://github.com/rubentalstra/FerroEHR/issues/3324) | Planned | — |
| [GDPR](https://eur-lex.europa.eu/eli/reg/2016/679/oj) | EU | Art. 21(6) | law(EU): a per-subject research objection (Art. 21(6) GDPR) that the cohort queries and the secondary-use read model honour | [#3325](https://github.com/rubentalstra/FerroEHR/issues/3325) | Planned | — |
