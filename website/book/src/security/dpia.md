...
| R5 | Content identifies a person without carrying an identifier | None in the query engine | A rare diagnosis with a date and a place identifies without any identifier field. Small-cell suppression is designed with the cross-domain cohort query and is not built: [#3159](https://github.com/rubentalstra/FerroEHR/issues/3159) |
