...
if [[ "${1:-}" == "--self-test" ]]; then
  ...
  mutations=(
    ...
    "the FerroTERM digest moved off the values pin|${self_chart}|s|@sha256:b1ef8038|@sha256:0000c0de|"
    "the helper pin moved without the annotation|${self_helpers}|s|^0\\.1\\.3$|9.9.9|"
    "the values digest moved without the annotation|${self_values}|s|^    digest: sha256:b1ef8038|    digest: sha256:0000c0de|"
  )
