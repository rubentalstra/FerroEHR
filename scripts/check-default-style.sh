...
#
# Usage: scripts/check-default-style.sh [--all | <file>...]
...
(scripts/check-default-style.sh)"
...
in the struct's \`impl Default\` (scripts/check-default-style.sh)"
...
reads it (scripts/check-default-style.sh)"
    fi
