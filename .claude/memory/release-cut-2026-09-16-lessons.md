...
**How to apply:** at every cut check the sandbox database generation first; if the release changes the storage generation, plan the wipe before the tag. Background pollers get killed under memory pressure on this box; use Monitor tasks. Related: [[release-pr-chart-and-third-party-images]], [[history-rewrite-2026-09-16]].
