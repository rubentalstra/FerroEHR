// @generated-from-template templates/openehr-base/foundation_types/time/iso8601_timezone_impl.rs — DO NOT EDIT; edit the source and re-run `openehr-codegen -- emit`.
