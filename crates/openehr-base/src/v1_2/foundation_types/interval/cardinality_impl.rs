// @generated-from-template templates/openehr-base/foundation_types/interval/cardinality_impl.rs — DO NOT EDIT; edit the source and re-run `openehr-codegen -- emit`.
