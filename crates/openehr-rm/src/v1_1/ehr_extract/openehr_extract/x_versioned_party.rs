// @generated by openehr-codegen from BMM (`X_VERSIONED_PARTY`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: Apache-2.0

//! The openEHR `X_VERSIONED_PARTY` spec class, generated from the vendored BMM
//! meta-model.
...
pub struct XVersionedParty {
    ...
    pub versions: Option<Vec<OriginalVersion<Party>>>,
}
