// @generated by openehr-codegen from BMM (`X_VERSIONED_EHR_ACCESS`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: BUSL-1.1 AND Apache-2.0

//! The openEHR `X_VERSIONED_EHR_ACCESS` spec class, generated from the vendored BMM
//! meta-model.
...
#[doc(alias = "X_VERSIONED_EHR_ACCESS")]
...
pub struct XVersionedEhrAccess {
    ...
    pub versions: Option<Vec<OriginalVersion<EhrAccess>>>,
}
