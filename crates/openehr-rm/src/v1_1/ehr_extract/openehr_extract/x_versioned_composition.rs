// @generated by openehr-codegen from BMM (`X_VERSIONED_COMPOSITION`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: Apache-2.0

//! The openEHR `X_VERSIONED_COMPOSITION` spec class, generated from the vendored BMM
//! meta-model.
...
#[doc(alias = "X_VERSIONED_COMPOSITION")]
#[derive(Debug, Clone, PartialEq)]
pub struct XVersionedComposition {
    ...
    pub versions: Option<Vec<OriginalVersion<Composition>>>,
}
