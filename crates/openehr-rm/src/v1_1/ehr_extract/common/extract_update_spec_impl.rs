...
use crate::v1_1::ehr_extract::common::extract_update_spec::ExtractUpdateSpec;
...
impl Validate for ExtractUpdateSpec {
    fn validate_invariants(&self, out: &mut Vec<InvariantViolation>) {
        ...
        crate::v1_1::validate::generated::extract_update_spec_core(
    ...
    fn spec(
        ...
        triggers: Option<
            openehr_base::containers::NonEmptyVec<
                crate::v1_1::data_types::text::dv_coded_text::DvCodedText,
            >,
        >,
    ) -> ExtractUpdateSpec {
        ExtractUpdateSpec {
            ...
            repeat_period: repeat.then(|| {
                crate::v1_1::data_types::quantity::date_time::dv_duration::DvDuration {
                    value: "P1D".to_owned(),
                    normal_status: None,
                    normal_range: None,
            ...
            update_method: crate::v1_1::data_types::text::code_phrase::CodePhrase {
                terminology_id:
