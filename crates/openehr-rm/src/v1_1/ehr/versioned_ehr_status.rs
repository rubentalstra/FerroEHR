// @generated by openehr-codegen from BMM (`VERSIONED_EHR_STATUS`) — DO NOT EDIT.
// SPDX-FileCopyrightText: FerroEHR contributors
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: MIT AND Apache-2.0

//! The openEHR `VERSIONED_EHR_STATUS` spec class, generated from the vendored BMM
//! meta-model.
...
#[doc(alias = "VERSIONED_EHR_STATUS")]
