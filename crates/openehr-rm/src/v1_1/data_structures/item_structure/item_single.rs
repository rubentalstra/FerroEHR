// @generated by openehr-codegen from BMM (`ITEM_SINGLE`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: Apache-2.0

//! The openEHR `ITEM_SINGLE` spec class, generated from the vendored BMM
//! meta-model.
...
pub struct ItemSingle {
    ...
    /// The `item` attribute of openEHR `ITEM_SINGLE` (the vendored BMM carries no documentation for it).
    pub item: Box<Element>,
}
