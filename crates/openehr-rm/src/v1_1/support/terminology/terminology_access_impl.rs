// @generated-from-template templates/openehr-rm/support/terminology/terminology_access_impl.rs — DO NOT EDIT; edit the source and re-run `openehr-codegen -- emit`.
