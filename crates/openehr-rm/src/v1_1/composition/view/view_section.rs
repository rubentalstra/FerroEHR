// @generated by openehr-codegen from BMM (`VIEW_SECTION`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: Apache-2.0

//! The openEHR `VIEW_SECTION` spec class, generated from the vendored BMM
//! meta-model.
...
use crate::v1_1::composition::view::view_item::ViewItem;
...
/// The openEHR `VIEW_SECTION` class (the vendored BMM carries no documentation for it).
#[doc(alias = "VIEW_SECTION")]
...
pub struct ViewSection {
    ...
    /// The `items` attribute of openEHR `VIEW_SECTION` (the vendored BMM carries no documentation for it).
    pub items: Option<Vec<ViewItem>>,
}
