// @generated by openehr-codegen from BMM (`SECTION`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: BUSL-1.1 AND Apache-2.0

//! The openEHR `SECTION` spec class, generated from the vendored BMM
//! meta-model.
...
use crate::v1_1::composition::content::content_item::ContentItem;
...
///
/// Created according to archetyped structures for typical headings such as SOAP,  physical examination, but also pathology result heading structures.  Should not be used instead of `ENTRY` hierarchical structures.
#[doc(alias = "SECTION")]
...
pub struct Section {
    ...
    /// * more `SECTIONs`;
    /// * `ENTRYs`.
    pub items: Option<openehr_base::containers::NonEmptyVec<ContentItem>>,
}
