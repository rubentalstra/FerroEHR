// @generated-from-template templates/openehr-rm/overrides/v1_1/demographic/party_impl.rs (per-generation override) — DO NOT EDIT; edit the source and re-run `openehr-codegen -- emit`.
