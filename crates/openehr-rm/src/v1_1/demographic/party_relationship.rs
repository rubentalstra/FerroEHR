// @generated by openehr-codegen from BMM (`PARTY_RELATIONSHIP`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: Apache-2.0

//! The openEHR `PARTY_RELATIONSHIP` spec class, generated from the vendored BMM
//! meta-model.
