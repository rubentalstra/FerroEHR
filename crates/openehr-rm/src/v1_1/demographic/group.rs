// @generated by openehr-codegen from BMM (`GROUP`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: Apache-2.0

//! The openEHR `GROUP` spec class, generated from the vendored BMM
//! meta-model.
...
///
/// A typical clinical example is that of the specialist care team, e.g.  cardiology team . The members of the group usually work together.
#[doc(alias = "GROUP")]
