...
pub(super) static CLASSES: &[RmClass] = &[
    ...
    RmClass {
        ...
        attributes: &[
            ...
            RmAttribute {
                name: "duration",
                declared_type: "Iso8601_duration",
                container: Container::None,
                is_mandatory: false,
                type_params: &[],
                cardinality: None,
...
pub(super) static ENUMERATIONS: &[RmEnumeration] = &[
    ...
    RmEnumeration {
        ...
        literals: &[
            RmEnumLiteral {
                name: "active",
                value: EnumValue::Str("active"),
            },
            RmEnumLiteral {
                name: "inactive",
                value: EnumValue::Str("inactive"),
            },
        ],
    },
];
