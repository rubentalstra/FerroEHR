...
impl Validate for ResourceDescription {
    fn validate_invariants(&self, out: &mut Vec<InvariantViolation>) {
        crate::validate::generated::resource_description_core(
    ...
    fn description() -> ResourceDescription {
        ResourceDescription {
            ...
            details: std::iter::once((
                "en".to_owned(),
                crate::common::resource::resource_description_item::ResourceDescriptionItem {
                    language: crate::data_types::text::code_phrase::CodePhrase {
                        terminology_id:
                            openehr_base::base_types::identification::terminology_id::TerminologyId {
