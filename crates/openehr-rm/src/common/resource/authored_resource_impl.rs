...
use crate::common::resource::authored_resource::AuthoredResource;
use openehr_base::validate::{InvariantViolation, Validate};

impl Validate for AuthoredResource {
    fn validate_invariants(&self, out: &mut Vec<InvariantViolation>) {
        crate::validate::generated::authored_resource_core(
            self.is_controlled,
...
mod tests {
    ...
    fn resource(is_controlled: Option<bool>) -> AuthoredResource {
        AuthoredResource {
            original_language: crate::data_types::text::code_phrase::CodePhrase {
                terminology_id:
