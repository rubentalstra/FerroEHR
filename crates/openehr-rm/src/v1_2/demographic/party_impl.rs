// @generated-from-template templates/openehr-rm/demographic/party_impl.rs — DO NOT EDIT; edit the source and re-run `openehr-codegen -- emit`.
...
use crate::v1_2::demographic::party::Party;
