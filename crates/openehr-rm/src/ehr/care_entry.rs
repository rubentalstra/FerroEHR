...
//   confidence: high
//   todos: 1
//   note: abstract-with-attributes per ADR-001 §3 (CareEntryData + CareEntryApi); no attributes/functions/invariants of its own besides protocol/guideline_id; the sole marker is the ItemStructure forward-reference import.
// ─────────────────────────────────────────────
