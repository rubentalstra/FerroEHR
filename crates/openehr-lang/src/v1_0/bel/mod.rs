...
use crate::v1_0::beom::core::assertion::Assertion;
use crate::v1_0::beom::core::assignment::Assignment;
use crate::v1_0::beom::core::expr_literal::ExprLiteral;
use crate::v1_0::beom::core::expr_value::ExprValue;
use crate::v1_0::beom::core::expr_value_ref::ExprValueRef;
use crate::v1_0::beom::core::expr_variable_ref::ExprVariableRef;
use crate::v1_0::beom::core::expression::Expression;
use crate::v1_0::beom::core::operator_kind::OperatorKind;
use crate::v1_0::beom::core::statement::Statement;
use crate::v1_0::beom::core::variable_declaration::VariableDeclaration;
use crate::v1_0::beom::types::expr_type_def::ExprTypeDef;
use crate::v1_0::beom::types::type_def_object_ref::TypeDefObjectRef;
...
pub fn parse_statements_with<B: BelBuilder>(
    ...
    let tokens = crate::v1_0::lexer::lex_bel(src).map_err(|failure| BelError::Lex {
...
impl BelBuilder for BeomBuilder {
    ...
    fn function_call(&mut self, name: &str, args: Vec<Expression>) -> Expression {
        ...
        Expression::ExprFunctionCall(
            crate::v1_0::beom::core::expr_function_call::ExprFunctionCall {
    ...
    fn binary(
        ...
        Expression::ExprBinaryOperator(Box::new(
            crate::v1_0::beom::core::expr_binary_operator::ExprBinaryOperator {
    ...
    fn unary(&mut self, op: OperatorKind, symbol: &str, operand: Expression) -> Expression {
        Expression::ExprUnaryOperator(Box::new(
            crate::v1_0::beom::core::expr_unary_operator::ExprUnaryOperator {
                precedence_overridden: None,
                operator: op,
                symbol: Some(symbol.to_owned()),
    ...
    fn for_all(
        ...
        Ok(Expression::ExprForAll(Box::new(
            crate::v1_0::beom::core::expr_for_all::ExprForAll {
                precedence_overridden: None,
