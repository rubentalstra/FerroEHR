...
//! [`crate::v1_0::el::parse_boolean_expression_with`].

use crate::v1_0::el::{ElBuilder, ElError, ElLiteral, ElOperator};
...
/// `master03` escapes).
///
/// The lexer has already run [`crate::v1_0::escape::validate`] over the same text,
