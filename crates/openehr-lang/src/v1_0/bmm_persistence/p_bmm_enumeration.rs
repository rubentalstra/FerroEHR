...
use crate::v1_0::bmm_persistence::p_bmm_enumeration_integer::PBmmEnumerationInteger;
use crate::v1_0::bmm_persistence::p_bmm_enumeration_string::PBmmEnumerationString;
