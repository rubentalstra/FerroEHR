...
//! [`crate::bmm_persistence::error::PBmmReadError`], which stay fail-fast
...
pub enum PBmmValidityFinding {
    ...
    /// [`crate::bmm_persistence::error::PBmmReadError::ClassNotInAnyPackage`].
...
/// [`crate::bmm_persistence::create_model::create_bmm_model`] produced from
...
/// # Ok::<(), openehr_lang::bmm_persistence::error::PBmmReadError>(())
/// ```
#[must_use]
...
mod tests {
    ...
    use crate::bmm_persistence::validate::validate_schema;
