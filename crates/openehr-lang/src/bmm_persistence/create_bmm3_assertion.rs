...
use crate::bmm_persistence::create_bmm3_model::build_named_unitary_type;
use crate::bmm_persistence::create_model::Builder;
use crate::bmm_persistence::p_bmm_class::PBmmClass;
use crate::bmm_persistence::validate::AssertionKind;
use crate::bmm_persistence::validate::PBmmValidityFinding;
...
impl ElBuilder for Bmm3ElBuilder<'_, '_, '_> {
    ...
    fn literal(
        ...
        Ok(ElExpression::ElLiteral(ElLiteral {
            ...
            // boundary of
            // [`crate::bmm3::core::literal_value::bmm_literal_value_impl`];
