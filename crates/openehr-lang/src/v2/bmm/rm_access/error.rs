...
//! ([`crate::v2::bmm_persistence::error::PBmmReadError`], wrapped) plus the
...
pub enum RmAccessError {
    ...
    Schema {
        ...
        /// [`crate::v2::bmm_persistence::include_resolution::resolve_includes`] or
        /// [`crate::v2::bmm_persistence::create_model::create_bmm_model`].
        #[source]
        source: crate::v2::bmm_persistence::error::PBmmReadError,
    },
