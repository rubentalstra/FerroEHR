...
//! `*_impl.rs` sibling
//! [`crate::v2::bmm::rm_access::schema_descriptor::SchemaDescriptor`]), which already
...
use crate::v2::bmm::core::bmm_definitions::BmmDefinitionsData;
use crate::v2::bmm::core::bmm_model::BmmModel;
use crate::v2::bmm::rm_access::error::RmAccessError;
use crate::v2::bmm::rm_access::schema_descriptor::SchemaDescriptor;
use crate::v2::bmm_persistence::create_model::create_bmm_model;
use crate::v2::bmm_persistence::include_resolution::resolve_includes;
use crate::v2::bmm_persistence::p_bmm_schema::PBmmSchema;
use crate::v2::bmm_persistence::p_bmm_schema_descriptor::PBmmSchemaDescriptor;
use crate::v2::bmm_persistence::reader::read_schema;
...
impl SchemaDescriptor {
    ...
    /// ([`crate::v2::bmm_persistence::reader::read_schema`]), and the pinned syntax
    ...
    /// [`crate::v2::bmm::rm_access::reference_model_access::ReferenceModelAccess::all_schemas`]
    /// — matched case-insensitively, because the vendored schemas write include
    /// ids in either case and
    /// [`crate::v2::bmm_persistence::include_resolution::resolve_includes`] matches
    ...
    /// [`crate::v2::bmm::rm_access::reference_model_access::ReferenceModelAccess::reload_schemas`]
    ...
    /// see [`crate::v2::bmm_persistence::reader`]) and by the transform (every
    /// symbolic reference resolved — see
    /// [`crate::v2::bmm_persistence::create_model`]). What is left for the
    ...
    /// [`crate::v2::bmm_persistence::include_resolution::resolve_includes`] does.
    ///
    /// # Errors
    ...
    ///
    /// Lower-cased, like
    /// [`crate::v2::bmm_persistence::p_bmm_schema::PBmmSchema::schema_id`]. Both
