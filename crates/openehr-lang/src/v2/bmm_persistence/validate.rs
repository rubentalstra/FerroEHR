...
//! [`crate::v2::bmm_persistence::error::PBmmReadError`], which stay fail-fast
...
pub enum PBmmValidityFinding {
    ...
    /// [`crate::v2::bmm_persistence::error::PBmmReadError::ClassNotInAnyPackage`].
...
/// [`crate::v2::bmm_persistence::create_model::create_bmm_model`] produced from
...
/// # Ok::<(), openehr_lang::v2::bmm_persistence::error::PBmmReadError>(())
/// ```
#[must_use]
...
mod tests {
    ...
    use crate::v2::bmm_persistence::validate::validate_schema;
