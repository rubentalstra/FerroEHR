...
//! hand-written [`crate::el`] parser over the vendored EL grammar, driving a
...
use crate::el::ElBuilder;
use crate::el::ElError;
use crate::el::ElOperator;
use crate::el::parse_boolean_expression_with;
use crate::v2::bmm_persistence::create_bmm3_model::build_named_unitary_type;
...
use crate::v3::bmm3::core::entity::bmm_tuple_type::BmmTupleType;
...
use crate::v3::bmm3::core::feature::bmm_readonly_variable::BmmReadonlyVariable;
use crate::v3::bmm3::core::feature::bmm_result::BmmResult;
use crate::v3::bmm3::core::feature::bmm_self::BmmSelf;
use crate::v3::bmm3::core::feature::bmm_static::BmmStatic;
use crate::v3::bmm3::core::feature::bmm_writable_variable::BmmWritableVariable;
...
use crate::v3::bmm3::expression::el_attached::ElAttached;
use crate::v3::bmm3::expression::el_binary_operator::ElBinaryOperator;
use crate::v3::bmm3::expression::el_boolean_expression::ElBooleanExpression;
use crate::v3::bmm3::expression::el_expression::ElExpression;
use crate::v3::bmm3::expression::el_function_agent::ElFunctionAgent;
use crate::v3::bmm3::expression::el_function_call::ElFunctionCall;
use crate::v3::bmm3::expression::el_literal::ElLiteral;
use crate::v3::bmm3::expression::el_property_ref::ElPropertyRef;
use crate::v3::bmm3::expression::el_readonly_variable::ElReadonlyVariable;
use crate::v3::bmm3::expression::el_static_ref::ElStaticRef;
use crate::v3::bmm3::expression::el_tuple::ElTuple;
use crate::v3::bmm3::expression::el_tuple_item::ElTupleItem;
use crate::v3::bmm3::expression::el_type_ref::ElTypeRef;
use crate::v3::bmm3::expression::el_unary_operator::ElUnaryOperator;
use crate::v3::bmm3::expression::el_value_generator::ElValueGenerator;
use crate::v3::bmm3::expression::el_writable_variable::ElWritableVariable;
...
impl ElBuilder for Bmm3ElBuilder<'_, '_, '_> {
    ...
    fn literal(
        ...
        Ok(ElExpression::ElLiteral(ElLiteral {
            ...
            // boundary of
            // [`crate::v3::bmm3::core::literal_value::bmm_literal_value_impl`];
