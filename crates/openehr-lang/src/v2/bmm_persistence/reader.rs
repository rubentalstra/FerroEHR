...
//! ([`crate::v2::bmm_persistence::include_resolution::resolve_includes`]) →
//! instantiate ([`crate::v2::bmm_persistence::create_model::create_bmm_model`]).
//!
...
//! [`crate::v2::bmm_persistence::create_model`]'s job. Two further attributes are
...
//! this schema's own [`crate::v2::bmm_persistence::p_bmm_schema::PBmmSchema::schema_id`],
...
use crate::v2::bmm::core::bmm_include_spec::BmmIncludeSpec;
...
use crate::v2::bmm_persistence::p_bmm_class::PBmmClassData;
use crate::v2::bmm_persistence::p_bmm_constant::PBmmConstant;
use crate::v2::bmm_persistence::p_bmm_container_function_parameter::PBmmContainerFunctionParameter;
use crate::v2::bmm_persistence::p_bmm_container_property::PBmmContainerProperty;
use crate::v2::bmm_persistence::p_bmm_container_property::PBmmContainerPropertyData;
use crate::v2::bmm_persistence::p_bmm_container_type::PBmmContainerType;
use crate::v2::bmm_persistence::p_bmm_container_type::PBmmContainerTypeData;
use crate::v2::bmm_persistence::p_bmm_enumeration::PBmmEnumeration;
use crate::v2::bmm_persistence::p_bmm_enumeration::PBmmEnumerationData;
use crate::v2::bmm_persistence::p_bmm_enumeration_integer::PBmmEnumerationInteger;
use crate::v2::bmm_persistence::p_bmm_enumeration_string::PBmmEnumerationString;
...
use crate::v2::bmm_persistence::p_bmm_generic_function_parameter::PBmmGenericFunctionParameter;
use crate::v2::bmm_persistence::p_bmm_generic_parameter::PBmmGenericParameter;
use crate::v2::bmm_persistence::p_bmm_generic_property::PBmmGenericProperty;
use crate::v2::bmm_persistence::p_bmm_generic_type::PBmmGenericType;
use crate::v2::bmm_persistence::p_bmm_indexed_container_property::PBmmIndexedContainerProperty;
use crate::v2::bmm_persistence::p_bmm_indexed_container_type::PBmmIndexedContainerType;
use crate::v2::bmm_persistence::p_bmm_interface::PBmmInterface;
use crate::v2::bmm_persistence::p_bmm_open_type::PBmmOpenType;
...
use crate::v2::bmm_persistence::p_bmm_schema_impl::compose_schema_id;
use crate::v2::bmm_persistence::p_bmm_simple_type::PBmmSimpleType;
use crate::v2::bmm_persistence::p_bmm_single_function_parameter::PBmmSingleFunctionParameter;
use crate::v2::bmm_persistence::p_bmm_single_function_parameter_open::PBmmSingleFunctionParameterOpen;
use crate::v2::bmm_persistence::p_bmm_single_property::PBmmSingleProperty;
use crate::v2::bmm_persistence::p_bmm_single_property_open::PBmmSinglePropertyOpen;
...
/// [`crate::v2::bmm_persistence::include_resolution::resolve_includes`]) and its
/// `bmm_*` in-memory caches are `None` (that is
/// [`crate::v2::bmm_persistence::create_model::create_bmm_model`]).
///
/// # Errors
...
/// in scope — [`crate::v2::bmm_persistence::create_model::create_bmm_model`]'s
