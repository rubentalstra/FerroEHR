...
//!   ([`crate::v2::bmm::core::bmm_model::BmmModel::property_definition`])
...
//!   `crate::v3::bmm3` emits it — and
//!   [`crate::v2::bmm_persistence::create_bmm3_model::create_bmm3_model`] materialises
...
use crate::v2::bmm::core::bmm_class::BmmClass;
use crate::v2::bmm::core::bmm_class::BmmClassData;
use crate::v2::bmm::core::bmm_container_property::BmmContainerProperty;
use crate::v2::bmm::core::bmm_container_type::BmmContainerType;
use crate::v2::bmm::core::bmm_container_type::BmmContainerTypeData;
use crate::v2::bmm::core::bmm_enumeration::BmmEnumeration;
use crate::v2::bmm::core::bmm_enumeration::BmmEnumerationData;
use crate::v2::bmm::core::bmm_enumeration_integer::BmmEnumerationInteger;
use crate::v2::bmm::core::bmm_enumeration_string::BmmEnumerationString;
use crate::v2::bmm::core::bmm_generic_class::BmmGenericClass;
use crate::v2::bmm::core::bmm_generic_parameter::BmmGenericParameter;
use crate::v2::bmm::core::bmm_generic_type::BmmGenericType;
use crate::v2::bmm::core::bmm_indexed_container_type::BmmIndexedContainerType;
use crate::v2::bmm::core::bmm_model::BmmModel;
use crate::v2::bmm::core::bmm_open_type::BmmOpenType;
use crate::v2::bmm::core::bmm_package::BmmPackage;
use crate::v2::bmm::core::bmm_property::BmmProperty;
use crate::v2::bmm::core::bmm_property::BmmPropertyData;
use crate::v2::bmm::core::bmm_simple_type::BmmSimpleType;
use crate::v2::bmm::core::bmm_type::BmmType;
...
pub(super) struct Builder<'a> {
    ...
    /// ([`crate::v2::bmm_persistence::p_bmm_schema::PBmmSchema::schema_id`]) — the
...
impl<'a> Builder<'a> {
    ...
    /// [`crate::v2::bmm_persistence::create_bmm3_model::create_bmm3_model`] lands the
    ...
    fn build_generic_parameter(
        &self,
        owner: &str,
        parameter: &crate::v2::bmm_persistence::p_bmm_generic_parameter::PBmmGenericParameter,
    ...
    pub(super) fn find_generic_parameter(
        ...
        owner: &PBmmClass,
        parameter: &str,
    ) -> Option<&'a crate::v2::bmm_persistence::p_bmm_generic_parameter::PBmmGenericParameter> {
    ...
    fn build_indexed_container_type(
        &self,
        context: &str,
        indexed: &crate::v2::bmm_persistence::p_bmm_indexed_container_type::PBmmIndexedContainerType,
        owner: &PBmmClass,
...
///   ([`crate::v2::bmm_persistence::p_bmm_enumeration_impl::DEFAULT_UNDERLYING_TYPE_NAME`]).
...
pub(super) fn qualify(prefix: &str, name: &str) -> String {
    if prefix.is_empty() {
        ...
        format!(
            "{prefix}{}{name}",
            crate::v2::bmm::core::bmm_definitions::BmmDefinitionsData::PACKAGE_NAME_DELIMITER
        )
    }
}
...
/// `crate::v3::bmm3` emits that shape, and
/// [`crate::v2::bmm_persistence::create_bmm3_model::create_bmm3_model`] carries the
