...
//! live in [`crate::v2::bmm_persistence::p_bmm_enumeration_impl`].
//!
...
impl PBmmClass {
    ...
    /// [`crate::v2::bmm_persistence::create_model`] materialises into
    ...
    /// set by [`crate::v2::bmm_persistence::include_resolution::resolve_includes`]
