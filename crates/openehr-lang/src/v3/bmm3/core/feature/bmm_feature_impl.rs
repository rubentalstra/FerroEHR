...
//! ([`crate::v3::bmm3::core::feature::bmm_feature_impl`]'s `signature`, `arity`) ARE
//! implemented here, so an invariant pass becomes ordinary work the day a v3
//! model is built from an editable source.

use crate::v3::bmm3::core::bmm_formal_element::BmmFormalElement;
...
use crate::v3::bmm3::core::entity::bmm_property_type::BmmPropertyType;
...
use crate::v3::bmm3::core::feature::bmm_routine::BmmRoutine;
use crate::v3::bmm3::core::feature::bmm_singleton::BmmSingleton;
use crate::v3::bmm3::core::feature::bmm_unitary_property::BmmUnitaryProperty;
