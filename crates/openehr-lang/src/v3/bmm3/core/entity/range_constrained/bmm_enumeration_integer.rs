// @generated by openehr-codegen from BMM (`BMM_ENUMERATION_INTEGER`) — DO NOT EDIT.

//! The openEHR `BMM_ENUMERATION_INTEGER` spec class, generated from the vendored BMM
//! meta-model.
...
use crate::v3::bmm3::core::literal_value::bmm_integer_value::BmmIntegerValue;
...
#[doc(alias = "BMM_ENUMERATION_INTEGER")]
#[derive(Debug, Clone, PartialEq)]
pub struct BmmEnumerationInteger {
    ...
    pub item_values: Option<Vec<BmmIntegerValue>>,
}
