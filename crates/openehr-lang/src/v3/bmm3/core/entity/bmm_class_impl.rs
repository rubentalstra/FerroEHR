...
//! [`crate::v2::bmm::core::bmm_class_impl`].
//!
...
use crate::v3::bmm3::core::entity::bmm_type_impl::ANY_TYPE_NAME;
...
impl BmmEnumeration {
    ...
    /// ([`crate::v2::bmm_persistence::error::PBmmReadError::EnumerationItemListsNotOneToOne`]).
    #[must_use]
