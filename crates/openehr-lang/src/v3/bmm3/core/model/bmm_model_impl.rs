...
//! ([`crate::v3::bmm3::core::entity::bmm_type_impl`],
//! [`crate::v3::bmm3::core::entity::bmm_class_impl`]): the queries that need the
...
//! surface at [`crate::v2::bmm::core::bmm_model_impl`]; the two never share an
