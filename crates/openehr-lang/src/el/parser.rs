...
//! [`crate::el::parse_boolean_expression_with`].

use crate::el::{ElBuilder, ElError, ElLiteral, ElOperator};
...
/// `master03` escapes).
///
/// The lexer has already run [`crate::escape::validate`] over the same text,
