...
use openehr_lang::bmm_persistence::create_bmm3_model::create_bmm3_model_reporting;
...
use openehr_lang::bmm_persistence::validate::AssertionKind;
...
use openehr_lang::bmm3::expression::el_expression::ElExpression;
...
fn assertions_model() -> Result<
    (
        openehr_lang::bmm3::core::model::bmm_model::BmmModel,
