...
#[test]
fn hoisted_feeder_system_audit_is_refused_with_its_path() -> Result<(), std::io::Error> {
...
#[test]
fn corrected_feeder_audit_twin_reads_and_round_trips() -> Result<(), std::io::Error> {
...
#[test]
fn placeholder_object_version_id_is_refused() -> Result<(), std::io::Error> {
    let src = read(&vendored(
...
#[test]
fn corrected_alternative_types_twin_reads_and_round_trips() -> Result<(), std::io::Error> {
