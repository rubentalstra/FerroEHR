...
impl crate::xml::runtime::ToXml for crate::aom2_model::types::Operatorvaluetype {
    fn write_xml(
        &self,
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::Operatorvaluetype {
    fn from_xml(
        ...
        crate::aom2_model::types::Operatorvaluetype::from_wire(__s.trim()).map_err(|__e| {
            crate::xml::runtime::XmlError::parse_source("element text of OperatorValueType", __e)
        })
    }
}

impl crate::xml::runtime::ToXml for crate::aom2_model::types::ValidityKind {
    fn write_xml(
        &self,
        w: &mut crate::xml::runtime::XmlWriter,
        tag: &str,
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::ValidityKind {
    fn from_xml(
        reader: &mut crate::xml::runtime::XmlReader,
        start: &crate::xml::runtime::StartTag,
    ) -> Result<Self, crate::xml::runtime::XmlError> {
        let __s = <::std::string::String as crate::xml::runtime::FromXml>::from_xml(reader, start)?;
        crate::aom2_model::types::ValidityKind::from_wire(__s.trim()).map_err(|__e| {
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::Archetype {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::Archetype {
            ...
            rules: __rules,
            terminology: __terminology
                .ok_or_else(|| reader.missing_child("ARCHETYPE", "terminology"))?,
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::ArchetypeTerm {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::ArchetypeTerm {
            id: start
                .attr("id")
                .ok_or_else(|| reader.missing_attribute("ARCHETYPE_TERM", "id"))?
                .to_string(),
            text: __text.ok_or_else(|| reader.missing_child("ARCHETYPE_TERM", "text"))?,
    ...
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::AuthoredArchetype {
            original_language: __original_language
                .ok_or_else(|| reader.missing_child("AUTHORED_ARCHETYPE", "original_language"))?,
            ...
            archetype_id: __archetype_id
                .ok_or_else(|| reader.missing_child("AUTHORED_ARCHETYPE", "archetype_id"))?,
            parent_archetype_id: __parent_archetype_id,
            definition: __definition
                .ok_or_else(|| reader.missing_child("AUTHORED_ARCHETYPE", "definition"))?,
            rules: __rules,
            terminology: __terminology
                .ok_or_else(|| reader.missing_child("AUTHORED_ARCHETYPE", "terminology"))?,
            is_specialised: __is_specialised,
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::Annotationlangset {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::Annotationlangset {
            id: start
                .attr("id")
                .ok_or_else(|| reader.missing_attribute("AnnotationLangSet", "id"))?
                .to_string(),
            items: __items,
        })
    }
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::Annotationpathset {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::Annotationpathset {
            id: start
                .attr("id")
                .ok_or_else(|| reader.missing_attribute("AnnotationPathSet", "id"))?
                .to_string(),
    ...
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::CAttribute {
            rm_attribute_name: start
                ...
                .ok_or_else(|| reader.missing_attribute("C_ATTRIBUTE", "rm_attribute_name"))?
                .to_string(),
            existence: __existence
                .ok_or_else(|| reader.missing_child("C_ATTRIBUTE", "existence"))?,
            differential_path: __differential_path,
            is_multiple: __is_multiple.unwrap_or(false),
            cardinality: __cardinality
                .ok_or_else(|| reader.missing_child("C_ATTRIBUTE", "cardinality"))?,
            children: __children,
        })
    }
}
    ...
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::CComplexObjectProxy {
            ...
            target_path: __target_path
                .ok_or_else(|| reader.missing_child("C_COMPLEX_OBJECT_PROXY", "target_path"))?,
        })
    }
}
    ...
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::CInteger {
            ...
            constraint: __constraint
                .ok_or_else(|| reader.missing_child("C_INTEGER", "constraint"))?,
            default_value: __default_value,
        })
    }
}
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::CReal {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::CReal {
            ...
            is_frozen: __is_frozen,
            assumed_value: __assumed_value,
            constraint: __constraint.ok_or_else(|| reader.missing_child("C_REAL", "constraint"))?,
            default_value: __default_value,
        })
    }
}
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::CString {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::CString {
            ...
            assumed_value: __assumed_value,
            constraint: __constraint
                .ok_or_else(|| reader.missing_child("C_STRING", "constraint"))?,
            default_value: __default_value,
        })
    }
}
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::CTerminologyCode {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::CTerminologyCode {
            ...
            assumed_value: __assumed_value,
            constraint: __constraint
                .ok_or_else(|| reader.missing_child("C_TERMINOLOGY_CODE", "constraint"))?,
            default_value: __default_value,
        })
    }
}
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::Codedefinitionset {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::Codedefinitionset {
            id: start
                .attr("id")
                .ok_or_else(|| reader.missing_attribute("CodeDefinitionSet", "id"))?
                .to_string(),
            items: __items,
        })
    }
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::OperatorKind {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::OperatorKind {
            value: start
                .attr("value")
                .ok_or_else(|| reader.missing_attribute("OPERATOR_KIND", "value"))?
                .to_string(),
        })
    }
}
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::SiblingOrder {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::SiblingOrder {
            ...
            sibling_node_id: __sibling_node_id
                .ok_or_else(|| reader.missing_child("SIBLING_ORDER", "sibling_node_id"))?,
        })
    }
}
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::TranslationDetails {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::TranslationDetails {
            id: start
                .attr("id")
                .ok_or_else(|| reader.missing_attribute("TRANSLATION_DETAILS", "id"))?
                .to_string(),
            language: __language
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::Termbindingset {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::Termbindingset {
            id: start
                .attr("id")
                .ok_or_else(|| reader.missing_attribute("TermBindingSet", "id"))?
                .to_string(),
            items: if __items.is_empty() {
                None
            } else {
...
impl crate::xml::runtime::FromXml for crate::aom2_model::types::ValueSet {
    fn from_xml(
        ...
        Ok(crate::aom2_model::types::ValueSet {
            id: start
                .attr("id")
                .ok_or_else(|| reader.missing_attribute("VALUE_SET", "id"))?
                .to_string(),
            members: __members,
        })
    }
