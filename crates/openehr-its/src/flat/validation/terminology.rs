...
//! single, shared hook in [`crate::rm_terminology`] (this crate does not
//! re-derive them): the same table the wire-boundary dispatcher
//! ([`crate::rm_validate::validate_rm_value`]) enforces. This pass keeps
...
//! See [`crate::rm_terminology`] for the per-slot spec citations
