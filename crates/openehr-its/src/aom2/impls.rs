    ...
    fn from_xml(
        ...
        Ok(crate::aom2::types::AuthoredResource {
            original_language: __original_language
                .ok_or_else(|| reader.missing_child("AUTHORED_RESOURCE", "original_language"))?,
...
impl crate::xml::runtime::FromXml for crate::aom2::types::PArchetype {
    fn from_xml(
        ...
        Ok(crate::aom2::types::PArchetype {
            ...
            artefact_type: __artefact_type
                .ok_or_else(|| reader.missing_child("P_ARCHETYPE", "artefact_type"))?,
            archetype_id: __archetype_id
                .ok_or_else(|| reader.missing_child("P_ARCHETYPE", "archetype_id"))?,
            parent_archetype_id: __parent_archetype_id,
            definition: __definition
                .ok_or_else(|| reader.missing_child("P_ARCHETYPE", "definition"))?,
            rules: __rules,
            terminology: __terminology
                .ok_or_else(|| reader.missing_child("P_ARCHETYPE", "terminology"))?,
        })
    }
}
    ...
    fn from_xml(
        ...
        Ok(crate::aom2::types::PArchetypeHrid {
            ...
            concept_id: __concept_id
                .ok_or_else(|| reader.missing_child("P_ARCHETYPE_HRID", "concept_id"))?,
        })
    }
}
...
impl crate::xml::runtime::FromXml for crate::aom2::types::PAuthoredArchetype {
    fn from_xml(
        ...
        Ok(crate::aom2::types::PAuthoredArchetype {
            ...
            uid: __uid,
            original_language: __original_language
                .ok_or_else(|| reader.missing_child("P_AUTHORED_ARCHETYPE", "original_language"))?,
            is_controlled: __is_controlled,
            description: __description,
            translations: __translations,
            annotations: __annotations,
            artefact_type: __artefact_type
                .ok_or_else(|| reader.missing_child("P_AUTHORED_ARCHETYPE", "artefact_type"))?,
            archetype_id: __archetype_id
                .ok_or_else(|| reader.missing_child("P_AUTHORED_ARCHETYPE", "archetype_id"))?,
            parent_archetype_id: __parent_archetype_id,
            definition: __definition
                .ok_or_else(|| reader.missing_child("P_AUTHORED_ARCHETYPE", "definition"))?,
            rules: __rules,
            terminology: __terminology
                .ok_or_else(|| reader.missing_child("P_AUTHORED_ARCHETYPE", "terminology"))?,
    ...
    fn from_xml(
        ...
        Ok(crate::aom2::types::PCComplexObjectProxy {
            ...
            target_path: __target_path
                .ok_or_else(|| reader.missing_child("P_C_COMPLEX_OBJECT_PROXY", "target_path"))?,
        })
    }
}
...
impl crate::xml::runtime::FromXml for crate::aom2::types::PCTerminologyCode {
    fn from_xml(
        ...
        Ok(crate::aom2::types::PCTerminologyCode {
            ...
            assumed_value: __assumed_value,
            constraint: __constraint
                .ok_or_else(|| reader.missing_child("P_C_TERMINOLOGY_CODE", "constraint"))?,
            default_value: __default_value,
        })
    }
}
