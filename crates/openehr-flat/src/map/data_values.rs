...
mod tests {
    ...
    fn coded_text_defaults_value_from_template() {
        use crate::webtemplate::{WebTemplateInput, WebTemplateInputType};
        let mut input = WebTemplateInput::new(WebTemplateInputType::CodedText, Some("code"));
        input
            .list
            .push(crate::webtemplate::WebTemplateCodedValue::new(
                "at0006",
    ...
    fn ordinal_defaults_from_template() {
        use crate::webtemplate::{WebTemplateInput, WebTemplateInputType};
        let mut cv =
            crate::webtemplate::WebTemplateCodedValue::new("at0015", Some("value1".to_owned()));
        cv.ordinal = Some(1);
        let mut input = WebTemplateInput::new(WebTemplateInputType::CodedText, Some("code"));
        input.list.push(cv);
