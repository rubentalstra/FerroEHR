...
//! ([`crate::validation::validate_archetype_conformance`]) reads. No openEHR
...
//! is validated by [`crate::validation::validate_rm_and_terminology`] (RM class
...
///
/// # Errors
/// [`crate::error::FlatError::InvalidTemplate`] if the template lacks an
/// archetype id.
