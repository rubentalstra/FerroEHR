...
use crate::path;
use crate::rmpath;
use crate::sim::{SimDocument, SimNode, is_present};
...
/// path enforces as hard rejections: [`crate::map::build_leaf`] returns
/// [`crate::error::FlatError::OtherSuffixConflict`] /
/// [`crate::error::FlatError::OtherOnClosedValueSet`] when it hits them during a
...
// [`crate::webtemplate::build_web_template`] time (via [`prepare_walk`]) and the
...
/// descendant — called once by [`crate::webtemplate::build_web_template`] on the
...
// implementation in [`openehr_rm::paths`], reached here via [`crate::rmpath`]
...
mod tests {
    ...
    fn segment_parsing_respects_brackets() {
        ...
        // via `crate::rmpath`; this asserts the validator sees the same segments.
        let segs =
            crate::rmpath::parse("/content[openEHR-EHR-SECTION.x.v1]/items[at0004,'Sys']/value");
    ...
    fn measure_ips_validation_full_cost() {
        ...
        let wt = crate::webtemplate::build_web_template(&opt).expect("build IPS WebTemplate");
