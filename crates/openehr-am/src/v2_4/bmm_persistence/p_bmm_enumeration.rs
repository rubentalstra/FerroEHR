...
use crate::v2_4::bmm_persistence::p_bmm_enumeration_integer::PBmmEnumerationInteger;
use crate::v2_4::bmm_persistence::p_bmm_enumeration_string::PBmmEnumerationString;
