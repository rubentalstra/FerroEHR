// @generated by openehr-codegen from BMM (`OPERATIONAL_TEMPLATE`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: Apache-2.0
// Hand-written spec functions/invariants live in the sibling `*_impl.rs`.

//! The openEHR `OPERATIONAL_TEMPLATE` spec class, generated from the vendored BMM
//! meta-model.
...
#[doc(alias = "OPERATIONAL_TEMPLATE")]
...
pub struct OperationalTemplate {
    ...
    pub component_terminologies: Option<std::collections::BTreeMap<String, ArchetypeTerminology>>,
    ...
    pub terminology_extracts: Option<std::collections::BTreeMap<String, ArchetypeTerminology>>,
}
