// @generated by openehr-codegen from BMM (`P_OPERATIONAL_TEMPLATE`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: BUSL-1.1 AND Apache-2.0

//! The openEHR `P_OPERATIONAL_TEMPLATE` spec class, generated from the vendored BMM
//! meta-model.
...
#[doc(alias = "P_OPERATIONAL_TEMPLATE")]
