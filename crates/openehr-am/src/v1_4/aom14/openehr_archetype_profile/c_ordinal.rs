// @generated by openehr-codegen from BMM (`C_ORDINAL`) — DO NOT EDIT.
// SPDX-FileCopyrightText: Ruben Talstra
// SPDX-FileCopyrightText: openEHR Foundation
// SPDX-License-Identifier: Apache-2.0

//! The openEHR `C_ORDINAL` spec class, generated from the vendored BMM
//! meta-model.
...
use crate::v1_4::aom14::openehr_archetype_profile::ordinal::Ordinal;
