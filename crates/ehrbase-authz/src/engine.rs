...
//!
//! [`CedarEngine`]: crate::cedar::CedarEngine
//! [`RemotePdp`]: crate::remote::RemotePdp
//! [`Combination`]: crate::request::Combination

use async_trait::async_trait;

use crate::request::{AuthzRequest, Decision};
...
pub trait PolicyEngine: Send + Sync + std::fmt::Debug {
    ...
    /// denying [`Combination`](crate::request::Combination); [`Decision::Permit`]
