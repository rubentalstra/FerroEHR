...
![Version: 6.0.32](https://img.shields.io/badge/Version-6.0.32-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.0.14](https://img.shields.io/badge/AppVersion-4.0.14-informational?style=flat-square)
...
|---|---|---|
| the **chart** (templates, defaults, this document) | `--version` | `6.0.32` |
| the **server image** | `image.tag` | `4.0.14` |
...
```console
cosign verify ghcr.io/rubentalstra/charts/ferroehr:6.0.32 \
...
```console
gh attestation verify oci://ghcr.io/rubentalstra/charts/ferroehr:6.0.32 \
  -R rubentalstra/FerroEHR
gh attestation verify oci://ghcr.io/rubentalstra/ferroehr:4.0.14 \
  -R rubentalstra/FerroEHR
```
