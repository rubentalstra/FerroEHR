...
![Version: 8.2.5](https://img.shields.io/badge/Version-8.2.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.2.3](https://img.shields.io/badge/AppVersion-4.2.3-informational?style=flat-square)
...
|---|---|---|
| the **chart** (templates, defaults, this document) | `--version` | `8.2.5` |
| the **server image** | `image.tag` | `4.2.3` |
...
```console
cosign verify ghcr.io/rubentalstra/charts/ferroehr:8.2.5 \
...
```console
gh attestation verify oci://ghcr.io/rubentalstra/charts/ferroehr:8.2.5 \
  -R rubentalstra/FerroEHR
gh attestation verify oci://ghcr.io/rubentalstra/ferroehr:4.2.3 \
  -R rubentalstra/FerroEHR
```
