...
|---|---|---|
| the **chart** (templates, defaults, this document) | `--version` | `8.2.0` |
...
```console
cosign verify ghcr.io/rubentalstra/charts/ferroehr:8.2.0 \
...
```console
gh attestation verify oci://ghcr.io/rubentalstra/charts/ferroehr:8.2.0 \
