...
![Version: 7.0.1](https://img.shields.io/badge/Version-7.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.0.15](https://img.shields.io/badge/AppVersion-4.0.15-informational?style=flat-square)
...
|---|---|---|
| the **chart** (templates, defaults, this document) | `--version` | `7.0.1` |
...
```console
cosign verify ghcr.io/rubentalstra/charts/ferroehr:7.0.1 \
...
```console
gh attestation verify oci://ghcr.io/rubentalstra/charts/ferroehr:7.0.1 \
