...
| P4 | Canonical JSON serialization (ITS-JSON) | done | ADR-002 self-tagging TypeTag + untagged closed enums across foundation/base/rm; full-RM harness in openehr-serde covers all 134 pinned schema classes with no exclusions and schema-validates every fixture; `cargo test` green; schema pinned @ 5acae056. Completed 2026-07-02. |
