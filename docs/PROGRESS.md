...
|---|---|---|---|---|
| 1 | 09 | Persistence foundation | **not-started (NEXT)** | `sqlx`+`sea-query`, vendored EHRbase v2 migrations, `testcontainers` PG18 |
| 2 | 10 | rm-db-format (RM↔JSONB) | not-started | `openehr-rm`, P09 |
