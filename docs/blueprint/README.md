...
**Retired sources (2026-07-11):** the SM design set (`docs/design/sm-platform/`,
SM-1..SM-6 shipped) and the finding-level spec-audit ledger
(`docs/spec-audit/`, consolidated into `00-THE-BLUEPRINT.md` §2) were pruned
after the arc closed; both live in git history. Citations to those paths inside
the chapter files are historical source references from authoring time
(2026-07-06/08), not live links.
