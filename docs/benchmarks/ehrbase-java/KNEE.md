...
**Knee: L = 1 → 10.1 req/s at p99 72767 µs** (the last sustainable step; SLO p99 ≤ 1 s, error ≤ 0.1%).

## Ladder

| L | req/s | error rate | p99 (µs) | requests | verdict |
|--:|--:|--:|--:|--:|---|
| 1 | 10.1 | 0.000% | 72767 | 1209 | sustained |
| 2 | 0.2 | 99.202% | 101311 | 20 | SLO breached |
