...
**Knee: L = 16 → 161.9 req/s at p99 844287 µs** (the last sustainable step; SLO p99 ≤ 1 s, error ≤ 0.1%).

## Ladder

| L | req/s | error rate | p99 (µs) | requests | dispatch lag (ms) | verdict |
|--:|--:|--:|--:|--:|--:|---|
| 16 | 161.9 | 0.015% | 844287 | 19433 | 31 | sustained |
| 24 | 144.1 | 39.070% | 26148863 | 17292 | 267 | SLO breached |
