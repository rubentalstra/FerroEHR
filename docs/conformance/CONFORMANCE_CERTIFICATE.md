...
| Date | 2026-07-12T06:20:46.058532Z |
...
| EHR service | EhrOperations | — | ECC-EHR-002 — EHR existence check — existing subject id | **FAIL** |
...
| EHR service | EhrOperations | — | ECC-EHR-007 — Create EHR — two EHRs same patient | **FAIL** |
| EHR service | EhrOperations | — | ECC-EHR-008 — Get EHR — existing EHR by EHR id | pass |
| EHR service | EhrOperations | — | ECC-EHR-009 — Get EHR — existing EHR by subject id | **FAIL** |
...
| EHR_STATUS | EhrStatus | — | ECC-STA-004 — Set EHR_STATUS is_queryable — bad EHR | **FAIL** |
| EHR_STATUS | EhrStatus | — | ECC-STA-005 — Set EHR_STATUS is_modifiable — existing EHR | pass |
| EHR_STATUS | EhrStatus | — | ECC-STA-006 — Set EHR_STATUS is_modifiable — bad EHR | **FAIL** |
| EHR_STATUS | EhrStatus | — | ECC-STA-007 — Clear EHR_STATUS is_queryable — existing EHR | pass |
| EHR_STATUS | EhrStatus | — | ECC-STA-008 — Clear EHR_STATUS is_queryable — bad EHR | **FAIL** |
| EHR_STATUS | EhrStatus | — | ECC-STA-009 — Clear EHR_STATUS is_modifiable — existing EHR | pass |
| EHR_STATUS | EhrStatus | — | ECC-STA-010 — Clear EHR_STATUS is_modifiable — bad EHR | **FAIL** |
...
| COMPOSITION | CompositionOps | — | ECC-COM-001 — Create composition — event | **FAIL** |
| COMPOSITION | CompositionOps | — | ECC-COM-002 — Create composition — persistent | **FAIL** |
...
| CONTRIBUTION (change sets) | ChangeSets | — | ECC-CTB-001 — Commit contribution — valid composition | **FAIL** |
...
| CONTRIBUTION (change sets) | ChangeSets | — | ECC-CTB-004 — Commit contribution — valid invalid compositions | **FAIL** |
...
| Template / OPT provisioning | Adl14ArchetypeProvisioning | — | ECC-TPL-001 — Upload OPT — valid OPT (provisions ADL 1.4 archetypes) | **FAIL** |
...
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-017 — Validate HISTORY — events card any summary ex OPT | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-018 — Validate HISTORY — events card 1plus summary ex OPT | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-019 — Validate HISTORY — events card 3plus summary ex OPT | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-020 — Validate HISTORY — events card OPT summary ex OPT | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-021 — Validate HISTORY — events card mand summary ex OPT | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-022 — Validate HISTORY — events card 3to5 summary ex OPT | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-023 — Validate HISTORY — events card any summary ex mand | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-024 — Validate HISTORY — events card 1plus summary ex mand | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-025 — Validate HISTORY — events card 3plus summary ex mand | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-026 — Validate HISTORY — events card OPT summary ex mand | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-027 — Validate HISTORY — events card mand summary ex mand | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-028 — Validate HISTORY — events card 3to5 summary ex mand | **FAIL** |
...
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-032 — Validate EVENT — type point event | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-033 — Validate EVENT — type interval event | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-034 — Validate ITEM_STRUCTURE — type any | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-035 — Validate ITEM_STRUCTURE — type item tree | **FAIL** |
...
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-039 — Validate DV_BOOLEAN — anything allowed | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-040 — Validate DV_BOOLEAN — only true allowed | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-041 — Validate DV_BOOLEAN — only false allowed | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-042 — Validate DV_IDENTIFIER — all pattern | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-043 — Validate DV_IDENTIFIER — all list | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-044 — Validate DV_TEXT — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-045 — Validate DV_TEXT — list | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-046 — Validate DV_CODED_TEXT — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-047 — Validate DV_CODED_TEXT — local codes | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-048 — Validate DV_CODED_TEXT — ext term | **FAIL** |
...
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-051 — Validate DV_SCALE — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-052 — Validate DV_SCALE — constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-053 — Validate DV_COUNT — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-054 — Validate DV_COUNT — range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-055 — Validate DV_COUNT — list | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-056 — Validate DV_QUANTITY — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-057 — Validate DV_QUANTITY — property | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-058 — Validate DV_QUANTITY — property units | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-059 — Validate DV_QUANTITY — property units mag | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-060 — Validate DV_PROPORTION — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-061 — Validate DV_PROPORTION — ratio | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-062 — Validate DV_PROPORTION — unitary | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-063 — Validate DV_PROPORTION — percent | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-064 — Validate DV_PROPORTION — fraction | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-065 — Validate DV_PROPORTION — integer fraction | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-066 — Validate DV_PROPORTION — any fraction | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-067 — Validate DV_PROPORTION — ratio range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-068 — Validate DV_INTERVAL<DV_COUNT> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-069 — Validate DV_INTERVAL<DV_COUNT> — lower upper | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-070 — Validate DV_INTERVAL<DV_COUNT> — lower upper list | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-071 — Validate DV_INTERVAL<DV_QUANTITY> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-072 — Validate DV_INTERVAL<DV_QUANTITY> — upper lower | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-073 — Validate DV_INTERVAL<DV_DATE_TIME> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-074 — Validate DV_INTERVAL<DV_DATE_TIME> — lower upper constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-075 — Validate DV_INTERVAL<DV_DATE_TIME> — lower upper range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-076 — Validate DV_INTERVAL<DV_DATE> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-077 — Validate DV_INTERVAL<DV_DATE> — lower upper constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-078 — Validate DV_INTERVAL<DV_DATE> — lower upper range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-079 — Validate DV_INTERVAL<DV_TIME> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-080 — Validate DV_INTERVAL<DV_TIME> — lower upper constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-081 — Validate DV_INTERVAL<DV_TIME> — lower upper range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-082 — Validate DV_INTERVAL<DV_DURATION> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-083 — Validate DV_INTERVAL<DV_DURATION> — constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-084 — Validate DV_INTERVAL<DV_DURATION> — range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-085 — Validate DV_INTERVAL<DV_ORDINAL> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-086 — Validate DV_INTERVAL<DV_ORDINAL> — constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-087 — Validate DV_INTERVAL<DV_SCALE> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-088 — Validate DV_INTERVAL<DV_SCALE> — constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-089 — Validate DV_INTERVAL<DV_PROPORTION> — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-090 — Validate DV_INTERVAL<DV_PROPORTION> — ratio | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-091 — Validate DV_INTERVAL<DV_PROPORTION> — unitary | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-092 — Validate DV_INTERVAL<DV_PROPORTION> — percentage | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-093 — Validate DV_INTERVAL<DV_PROPORTION> — fraction | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-094 — Validate DV_INTERVAL<DV_PROPORTION> — integer fraction | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-095 — Validate DV_INTERVAL<DV_PROPORTION> — ratio range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-096 — Validate DV_DURATION — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-097 — Validate DV_DURATION — fields | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-098 — Validate DV_DURATION — range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-099 — Validate DV_DURATION — fields range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-100 — Validate DV_TIME — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-101 — Validate DV_TIME — constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-102 — Validate DV_TIME — range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-103 — Validate DV_DATE — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-104 — Validate DV_DATE — constraint | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-105 — Validate DV_DATE — range | **FAIL** |
...
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-108 — Validate DV_DATE_TIME — range | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-109 — Validate DV_PARSABLE — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-110 — Validate DV_PARSABLE — value formalism | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-111 — Validate DV_MULTIMEDIA — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-112 — Validate DV_MULTIMEDIA — media type | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-113 — Validate DV_URI — open | pass |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-114 — Validate DV_URI — pattern | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-115 — Validate DV_URI — list | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-116 — Validate DV_EHR_URI — open | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-117 — Validate DV_EHR_URI — pattern | **FAIL** |
| Content / archetype validation | ArchetypeValidation | — | ECC-VAL-118 — Validate DV_EHR_URI — list | **FAIL** |
