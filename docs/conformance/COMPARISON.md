...
| | ferroehr | EHRbase |
|---|---|---|
| Product | ferroehr 3.20.0 | ehrbase 2.34.0 |
| Run date | 2026-08-23 | 2026-08-14 |
...
Both systems execute the **same committed CNF 2.0 catalogue** (1100 case-by-format
...
Runs compared: **ferroehr** (run of 2026-08-23) vs **EHRbase
