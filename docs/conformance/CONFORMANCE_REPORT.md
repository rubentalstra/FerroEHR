...
- Auth mode: basic
- Started: 2026-07-12T06:48:44.339403Z

**341 case×format executions · 311 passed · 4 failed · 0 not applicable.**
...
| VAL — Content / archetype validation | 119 | 115 | 4 | 0 | 0 | 0 |
...
- **ECC-VAL-001** Validate COMPOSITION — content card any context any (`val/comp-content-card-any-context-any`, json): 0 content item(s), context present → accepted: expected accepted (composition_create.yaml 201), got 422 ({"error":"Unprocessable Entity","message":"unprocessable entity: /: COMPOSITION.content is present but empty — a present list must be non-empty (COMPOSITION.Content_valid)"})
- **ECC-VAL-004** Validate COMPOSITION — content card OPT context any (`val/comp-content-card-opt-context-any`, json): 0 content item(s), context present → accepted: expected accepted (composition_create.yaml 201), got 422 ({"error":"Unprocessable Entity","message":"unprocessable entity: /: COMPOSITION.content is present but empty — a present list must be non-empty (COMPOSITION.Content_valid)"})
- **ECC-VAL-007** Validate COMPOSITION — content card any context mand (`val/comp-content-card-any-context-mand`, json): 0 content item(s), context present → accepted: expected accepted (composition_create.yaml 201), got 422 ({"error":"Unprocessable Entity","message":"unprocessable entity: /: COMPOSITION.content is present but empty — a present list must be non-empty (COMPOSITION.Content_valid)"})
- **ECC-VAL-010** Validate COMPOSITION — content card OPT context mand (`val/comp-content-card-opt-context-mand`, json): 0 content item(s), context present → accepted: expected accepted (composition_create.yaml 201), got 422 ({"error":"Unprocessable Entity","message":"unprocessable entity: /: COMPOSITION.content is present but empty — a present list must be non-empty (COMPOSITION.Content_valid)"})
...
| ArchetypeValidation | 115 | 4 | 0 | 0 | 0 | fail |
...
| SutConfig: no FHIR terminology provider configured on the SUT (EHRBASE_VALIDATION_EXTERNAL_TERMINOLOGY_* unset) — a `hl7.org/fhir/4.0` expand is rejected as `UnknownTerminologyService`. harness terminology server: http://127.0.0.1:53316 (fixture). The bundle (`openehr`) expand cases prove the TERMINOLOGY family; wire this by pointing the SUT at a FHIR server (host.docker.internal for a runner-host fixture, docs/design/terminology-server-integration.md §5). | 1 |
